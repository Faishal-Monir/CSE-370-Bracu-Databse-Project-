...
<head>
    ...
    <style>
        body {
            padding-top: 70px;
            position: relative; /* Added to make the footer behave correctly */
            margin-bottom: 60px; /* Added to prevent the footer from overlapping the form */
        }
        .profile-container {
            max-width: 800px;
            margin: 0 auto;
        ...
        .form-container {
            ...
            background-color: #f9f9f9; /* Added for background color */
            padding: 20px; /* Added for padding */
        ...
        .btn-primary {
            background-color: #007bff; /* Added for primary button color */
            border-color: #007bff; /* Added for primary button color */
        }
        .btn-primary:hover {
            background-color: #0056b3; /* Added for hover effect */
            border-color: #0056b3; /* Added for hover effect */
        }
        .btn-danger {
            background-color: #dc3545; /* Added for delete button color */
            border-color: #dc3545; /* Added for delete button color */
        }
        .btn-danger:hover {
            background-color: #c82333; /* Added for delete button hover effect */
            border-color: #bd2130; /* Added for delete button hover effect */
        }
    </style>
</head>
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="normalusers.php">Previous Page</a>
                </li>
            </ul>
